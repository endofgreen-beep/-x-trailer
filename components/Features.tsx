  ...
  return (
    <section id="features" className="relative py-24 bg-black overflow-hidden">
      {/*
        ...
        Background image only shown on desktop (md and up).
        Mobile devices get pure black background.
      */}
      <div className="absolute inset-0 z-0 hidden md:block">
        <div
            className="absolute inset-0 w-full h-full bg-contain bg-center bg-no-repeat md:bg-fixed opacity-50"
