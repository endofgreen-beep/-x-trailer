      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-[40%_55%] gap-12 lg:gap-24 items-center">
          ...
          <div className="order-2 lg:order-2 lg:-mr-24 lg:w-[110%]">
             <FadeIn>
                <div className="aspect-[16/10] rounded-2xl overflow-hidden shadow-2xl bg-gray-100 relative"
                  style={{
                    backgroundImage: "url('https://iili.io/friOPWP.jpg')",
                    ...
                    <img
                        ...
                        className="w-full h-full object-cover scale-115 md:scale-100 hover:scale-105 transition-transform duration-700"
                        loading="lazy"
                    />
                </div>
             </FadeIn>
